...
RXEQ <- function(t, y, pars) {
  ...
  with (as.list(c(y, pars)),{
    ...
    MICtrn[1] = MIC_1^beta[1] * tau[1]  * fPHYS[1]             #MIC_1 turnover to PHYSICAL SOM 
    MICtrn[2] = MIC_1^beta[1] * tau[1]  * fCHEM[1]             #MIC_1 turnover to CHEMICAL SOM  
    MICtrn[3] = MIC_1^beta[1] * tau[1]  * fAVAI[1]             #MIC_1 turnover to AVAILABLE SOM  
    ...
    MICtrn[4] = MIC_2^beta[2] * tau[2]  * fPHYS[2]             #MIC_2 turnover to PHYSICAL  SOM 
    MICtrn[5] = MIC_2^beta[2] * tau[2]  * fCHEM[2]             #MIC_2 turnover to CHEMICAL  SOM  
    MICtrn[6] = MIC_2^beta[2] * tau[2]  * fAVAI[2]             #MIC_2 turnover to AVAILABLE SOM  
